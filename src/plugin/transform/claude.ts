...
import { EMPTY_SCHEMA_PLACEHOLDER_DESCRIPTION, EMPTY_SCHEMA_PLACEHOLDER_NAME } from "../../constants";
 ...
 */
export function convertStopSequences(generationConfig: Record<string, unknown>): void {
