...
const optionDescriptions: Record<string, string> = {
  ...
  session_recovery: "Enable automatic session recovery from tool_result_missing errors.",
  ...
  empty_response_retry_delay_ms: "Delay in milliseconds between empty response retries.",
  tool_id_recovery:
  ...
  proactive_refresh_buffer_seconds: "Seconds before token expiry to trigger proactive refresh.",
  proactive_refresh_check_interval_seconds: "Interval between proactive refresh checks in seconds.",
  ...
  failure_ttl_seconds: "Time in seconds before a failed account is eligible for retry.",
