...
If you're seeing unusual rate limit behavior, please share in a [GitHub issue](https://github.com/luckdevx/opencode-antigravity-auth-fork/issues):
...
3. **Manual callback extraction** (advanced):
   ...
   - See [manual auth support](https://github.com/luckdevx/opencode-antigravity-auth-fork/issues) for how to extract the callback manually
...
Open an issue on [GitHub](https://github.com/luckdevx/opencode-antigravity-auth-fork/issues).
